...
#define RUNNING_LED_GPIO_Port GPIOE
#define AUDIO_CLK_Pin GPIO_PIN_9
#define AUDIO_CLK_GPIO_Port GPIOE
#define QSPI_CLK_Pin GPIO_PIN_10
#define QSPI_CLK_GPIO_Port GPIOE
#define EXT_LED1_Pin GPIO_PIN_11
#define EXT_LED1_GPIO_Port GPIOE
#define EXT_LED2_Pin GPIO_PIN_12
#define EXT_LED2_GPIO_Port GPIOE
#define EXT_LED3_Pin GPIO_PIN_13
#define EXT_LED3_GPIO_Port GPIOE
#define EXT_LED4_Pin GPIO_PIN_15
#define EXT_LED4_GPIO_Port GPIOE
